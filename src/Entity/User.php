...
// -----------------------------------------------------prénom------------------------------------------------------------------------
    ...
    #[Assert\Length(
        min: 2,
        max: 255,
        minMessage: 'Votre prenom doit etre au minimum de {{ limit }} caracteres',
...
#[Assert\NotBlank(message:"Le nom est obligatoire") ]
    #[Assert\Length(
        min: 2,
        max: 255,
        minMessage: 'Votre nom doit etre au minimum {{ limit }} caractères',
...
#[Assert\NotBlank(message:"L'email est obligatoire") ]
    #[Assert\Length(
        ...
        maxMessage: 'l\'email ne doit pas depasser {{ limit }} characters',
)]
#[Assert\Email(
    message: 'The email {{ value }} n\'ent pas valide',
)]
