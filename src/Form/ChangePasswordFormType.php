                ...
                'first_options' => [
                    'constraints' => [
                        ...
                        new Length([
                            'min' => 12, 
                            'max' => 255,
                            'minMessage' => 'Le nouveau mot de passe doit contenir au minimum {{ limit }} caracteres',
                            'maxMessage' => 'Le nouveau mot de passe doit contenir au maximum {{ limit }} caracteres',
                            // max length allowed by Symfony for security reason
                        ]),
                        new Regex([
